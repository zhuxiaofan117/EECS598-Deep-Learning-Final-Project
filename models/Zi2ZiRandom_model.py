...
class Zi2ZiRandomModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        parser.set_defaults(norm='batch', netG='unet_zi2zi', dataset_mode='alignedlabel')
        if is_train:
    ...
    def __init__(self, opt):
        ...
        self.loss_names = ['G_GAN', 'G_L1', 'D_real', 'D_fake', 'category', 'E']
    ...
    def encode(self, input_image):
        ...
        eps = torch.randn(std.size(0), std.size(1)).to(self.device)
